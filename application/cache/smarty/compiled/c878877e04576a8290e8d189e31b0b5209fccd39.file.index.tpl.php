...
<?php if ($_valid && !is_callable('content_4f707ce7909ff9_66104117')) {function content_4f707ce7909ff9_66104117($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ("bootstrap/site/header.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
      ...
      <header class="jumbotron subhead" id="overview">
        ...
        <div class="subnav">
          <ul class="nav nav-pills">
            ...
            <li><a href="javascript/tabs">Tab</a></li>
            <li><a href="javascript/tooltips">Tooltip</a></li>
            <li><a href="javascript/popovers">Popover</a></li>
            <li><a href="javascript/alerts">Alert</a></li>
            <li><a href="javascript/buttons">Button</a></li>
            <li><a href="javascript/collapse">Collapse</a></li>
            <li><a href="javascript/carousel">Carousel</a></li>
            <li><a href="javascript/typeahead">Typeahead</a></li>
          </ul>
        </div>
      </header>
      ...
      <div class="row">
        <div class="span3">
          <label>
            <h3><a href="javascript/modals">Modals</a></h3>
        ...
        <div class="span3">
          <label>
            <h3><a href="javascript/dropdowns">Dropdowns</a></h3>
        ...
        <div class="span3">
          <label>
            <h3><a href="javascript/scrollspy">Scrollspy</a></h3>
        ...
        <div class="span3">
          <label>
            <h3><a href="javascript/tabs">Togglable tabs</a></h3>
      ...
      <div class="row">
        <div class="span3">
          <label>
            <h3><a href="javascript/tooltips">Tooltips</a></h3>
        ...
        <div class="span3">
          <label>
            <h3><a href="javascript/popovers">Popovers</a> <small class="muted">*</small></h3>
            <p>Add small overlays of content, like those on the iPad, to any element for housing secondary information.</p>
            <p class="muted"><strong>*</strong> Requires <a href="javascript/tooltips">Tooltips</a> to be included</p>
          </label>
        </div>
        <div class="span3">
          <label>
            <h3><a href="javascript/alerts">Alert messages</a></h3>
            <p>The alert plugin is a tiny class for adding close functionality to alerts.</p>
          </label>
        </div>
        <div class="span3">
          <label>
            <h3><a href="javascript/buttons">Buttons</a></h3>
      ...
      <div class="row" style="margin-bottom: 9px;">
        <div class="span3">
          <label>
            <h3><a href="javascript/collapse">Collapse</a></h3>
            <p>Get base styles and flexible support for collapsible components like accordions and navigation.</p>
          </label>
        </div>
        <div class="span3">
          <label>
            <h3><a href="javascript/carousel">Carousel</a></h3>
            <p>Create a merry-go-round of any content you wish to provide an interactive slideshow of content.</p>
          </label>
        </div>
        <div class="span3">
          <label>
            <h3><a href="javascript/typeahead">Typeahead</a></h3>
